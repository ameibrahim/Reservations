...
$query = "SELECT pr.*, a.firstname, a.lastname, a.title, a.profile_picture FROM pending_reservations pr 
          JOIN academics a ON pr.academic_id = a.id 
...
<body>
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="student_pending_reservations.php" class="pending-reservations-btn">Pending Reservations</a></li>
            <li><a href="student_accepted_reservations.php" class="accepted-reservations-btn">Accepted Reservations</a></li>
            
            <li><a href="profile.php" class="profile-btn">Profile</a></li>
            <li><a href="settings.php" class="settings-btn">Settings</a></li>
            <li><a href="home.php" class="timetable-btn">Home</a></li>
        </ul>
    </div>
    <div class="container">
        ...
        <table>
            ...
            <?php while ($row = $result->fetch_assoc()) { 
                $academic_name = $row['title'] . ' ' . $row['firstname'] . ' ' . $row['lastname'];
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row['reservation_reason']; ?></td>
